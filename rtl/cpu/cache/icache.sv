...
// icache: 64KB 8-way 64B-line behavioral cache (single clock)
module icache
  import orca_pkg::*; (
  ...
  output paddr_t    wb_addr, /*verilator coverage_on*/  // COV-EXEMPT: wb_addr[11:0]=12'b0 結構恆定 (assign 於 L56), toggle 不可達; [63:12] 已由 f1_cache_tb Phase 6 功能覆蓋
