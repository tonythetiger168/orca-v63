//============================================================================
// ORCA v6.1 ZEN SoC — Phoenix-E AI Subsystem Integration
// Connects TPE v6.1 + AME v6.1 to CHI/AXI4 crossbar and CPU CSR interface
// 256-bit memory interface, edge server optimized
//============================================================================
`ifndef ORCA_SOC_TOP_V6_1_NPU_SV
`define ORCA_SOC_TOP_V6_1_NPU_SV
`include "orca_params.sv"
`include "orca_pkg.sv"
module orca_soc_top_v6_1_npu (
input  logic        clk
, input  logic        rst_n
// --------------------------------------------------------------------------
...
//  TPE v6.1 Instance
// --------------------------------------------------------------------------
orca_tpe_v6_1 #    ( .NUM_TILES(6)
, .TILE_DIM(16)
, .ACC_WIDTH(32)
, .DATA_WIDTH(8)
, .FIFO_DEPTH(1024)
, .AXI_DATA_W(256)    ) u_tpe (
.clk         (clk)
, .rst_n       (rst_n)
